...
export type GetArtistAlbumsResponse = GetItemsBaseResponse<SimplifiedSpotifyAlbum>;
...
export type GetAlbumTracksResponse = GetItemsBaseResponse<SimplifiedSpotifyTrack>;
...
export type SimplifiedSpotifyTrack = Omit<SpotifyTrack, 'album' | 'external_urls' | 'popularity'>;
