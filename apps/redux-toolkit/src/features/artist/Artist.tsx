...
import { SpotifyAlbum, SpotifyArtist } from '../../state/queries/models/spotify.models';
import Stack from '@mui/material/Stack';
import Box from '@mui/material/Box';
import Typography from '@mui/material/Typography';
import Skeleton from '@mui/material/Skeleton';
import HeadsetIcon from '@mui/icons-material/Headset';
import { useGetArtistQuery, useGetArtistTopTracksQuery } from '../../state/queries/artist.api';
...
const Artist: FC = () => {
  ...
  const skipQuery =
    !artistId || (typeof state?.images !== 'undefined' && typeof state?.name !== 'undefined');
  ...
  const { data: topTracksData, isFetching: isLoadingTopTracks } = useGetArtistTopTracksQuery(
    ...
    <Stack gap={1}>
      {!artist ? (
        ...
        <Stack direction="row" alignItems="center" justifyContent="space-between">
          ...
          <PlayButton type="artist" variant="action-button" size="large" dataUri={artist.uri} />
        </Stack>
      )}
      <Stack gap={2}>
