...
const Discography = lazy(() => import('../../features/artist/views/Discography'));
const RelatedArtists = lazy(() => import('../../features/artist/views/RelatedArtists'));
...
export const getArtistRoutes = (): RouteProps[] => [
  {
    ...
    children: (
      <>
        <Route index path={AppRoutes[RouteName.Artist].path} element={<Artist />} />
        <Route index path={AppRoutes[RouteName.Discography].path} element={<Discography />} />
        <Route index path={AppRoutes[RouteName.RelatedArtists].path} element={<RelatedArtists />} />
        <Route
          index
          path="*"
