...
const ScrollingContainer: FC<PropsWithChildren<unknown>> = (props: PropsWithChildren<unknown>) => {
  ...
  return (
    <StyledTitleScrollingContainer ref={containerRef} animating={animating} xDistance={xDistance}>
      {children}
